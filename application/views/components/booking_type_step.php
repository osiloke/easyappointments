                        ...
                        <div class="mb-3">
                            ...
                            <div id="provider-list" class="mb-3 <?php if (
                                ...
                                <div role="radiogroup" id="select-provider-tile">
                                    <div class="service-grid">
                                        <?php foreach ($available_providers
                                            as $provider) : ?>
                            ...
                            <div id="service-list" class="<?php if (
                                ...
                                <div class="pb-10 <?php if (count($available_providers) == 1) : ?>hidden<?php endif; ?>">
                                    <button data-step_index="1" class="button-back-provider rounded-[100px] flex flex-col gap-2 items-start justify-center shrink-0 relative overflow-hidden">
