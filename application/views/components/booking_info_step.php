...
<div id="wizard-frame-3" class="wizard-frame" style="display:none;">
            ...
            <div class="col-12 col-md-6 field-col mx-auto">
                <?php if ($display_first_name): ?>
                    <div class="mb-3">
                        ...
                        <input type="text" id="first-name" class="<?= $require_first_name ? 'required' : '' ?> form-control"
                            maxlength="100" />
                    </div>
                <?php endif ?>
                ...
                <?php if ($display_last_name): ?>
                    <div class="mb-3">
                        ...
                        <input type="text" id="last-name" class="<?= $require_last_name ? 'required' : '' ?> form-control"
                            maxlength="120" />
                    </div>
                <?php endif ?>
            ...
            <div class="col-12 col-md-6 field-col mx-auto">
                ...
                <?php if ($display_notes): ?>
                    <div class="mb-3">
                        ...
                        <textarea id="notes" maxlength="500" class="<?= $require_notes ? 'required' : '' ?> form-control"
                            rows="1"></textarea>
                    </div>
                <?php endif ?>
            </div>
    ...
    <div class="flex flex-row justify-between my-2">
        ...
        <button type="button" id="button-next-3" class="btn button-next btn-dark btn-primary" data-step_index="3">
            <?= lang('next') ?>
