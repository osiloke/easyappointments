...
?>
<label for="<?= $id ?>" class="w-full cursor-pointer m-0 relative text-sm">
    <input id="<?= $id ?>" name="select-service-tile" type="radio" value="<?= $id ?>" class="peer radio-primary checked:radio-primary active:radio-primary absolute 
           top-4 left-5 w-4 h-4 cursor-pointer" checked />
    <div
