...
<label class="card rounded-md shadow-none hover:bg-primary hover:border-primary hover:text-base-100 cursor-pointer transition-all" for="provider-<?= $id ?>" class="w-full cursor-pointer m-0 relative text-sm">
    ...
    <figure class="transition-all px-3 pt-3"><img class="rounded-md bg-cover object-cover" src="<?php if (
        $image != null
    ):
        $image
    else:
         ?>https://daisyui.com/images/stock/photo-1606107557195-0e29a4b5b4aa.jpg<?php
    endif; ?>" alt="Shoes" /></figure>
    <div class="card-body">
