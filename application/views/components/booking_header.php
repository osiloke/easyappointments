...
<div class="flex flex-col lg:flex-row justify-between item-center py-2 md:mx-4 mx-2 gap-2 text-center lg:text-left">
    ...
    <div class="join text-neutral-600 justify-center lg:justify-start">
        <div id="step-1" class="join-item active-step">
            <div class="py-2 justify-center items-center gap-2 inline-flex">
