    ...
    <div class="overflow-hidden bg-[#ffffff] rounded-lg border-solid border-grey-50 border shrink-0 w-full p-10" style="
        ...
        <div class="flex flex-col gap-6 items-start justify-start shrink-0">
            <?php if (sizeof($available_services) > 1) { ?>
                <button data-step_index="<?= $step ?>" class="button-back-service rounded-[100px] flex flex-col gap-2 items-start justify-center shrink-0 relative overflow-hidden">
                    <div class="flex flex-row gap-2 items-center justify-center self-stretch shrink-0 relative">
                        <svg class="shrink-0 relative overflow-visible" style="" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="flex flex-col gap-[5px] items-start justify-start shrink-0 relative">
                <div class="text-grey-1000 text-left relative flex items-center justify-start display-selected-service" style="
            ...
            <div>
                <div class="flex flex-col gap-0 items-start justify-start self-stretch shrink-0 relative">
                    <div class="text-[#888888] text-left uppercase relative " style="font: 700 12px/18px 'Inter', sans-serif">
                        Service Price
                    </div>
                    <div class="text-grey-900 text-left relative flex items-center justify-start display-selected-service-price" style="
                font: var(
                ...
                <div class="flex flex-col gap-0 items-start justify-start self-stretch shrink-0 relative">
                    <div class="text-sky-800 text-sm font-medium font-['DM Sans'] leading-tight display-selected-service-fee">
                    </div>
                </div>
            </div>
        </div>
